...
// var homepage = String(fs.readFileSync("../views/index.html"));
// var week1 = String(fs.readFileSync("./weeks/week1.handlebars"));
// var week2 = String(fs.readFileSync("./weeks/week2.handlebars"));
// var week3 = String(fs.readFileSync("./weeks/week3.handlebars"));
// var week4 = String(fs.readFileSync("./weeks/week4.handlebars"));
...
var source = fs.readFileSync('../views/layouts/main.handlebars', "utf8");
var content = {
...
//=======================================================================
var sourceA= fs.readFileSync("../views/layouts/index.handlebars", "utf8");
var contents={
  title: "Nelisa Spaza Shop",
  mostPopularProducts: "most popular product",
  leastPopularProducts: "least popular product",
...
var templates = handlebars.compile(sourceA);
var htmls = template(contents);
fs.writeFileSync("../views/statistics.handlebars", htmls);
